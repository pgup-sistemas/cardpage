...
<body>
<div class="card">
    <h2>Plano alterado para Free</h2>
    <p>Olá, {{ $user->name }}. Informamos que seu plano foi alterado para <strong>Free</strong>.</p>
    <p>Para reativar as funcionalidades Pro, acesse o painel e contrate o plano Pro.</p>
